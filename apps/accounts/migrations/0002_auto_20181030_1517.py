# Generated by Django 2.1.1 on 2018-10-30 15:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.SlugField(blank=True, default='', max_length=32)),
                ('value', models.TextField(blank=True, default='', help_text='JSON Object', max_length=1024)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.TextField(default='{}', help_text='JSON Object', max_length=1024)),
                ('type', models.CharField(blank=True, default='', max_length=16)),
            ],
        ),
